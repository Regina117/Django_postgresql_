...
class ApisqlApisql(models.Model):
...
class Author(models.Model):
    ...
    psevdo = models.CharField(max_length=50, blank=True, null=True)
...
class Orders(models.Model):
    info = models.TextField()  # This field type is a guess.
